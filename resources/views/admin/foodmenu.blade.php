            ...
            <div class="grid md:grid-cols-2 grid-cols-1 gap-6">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="title"
                        class=" text-black w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-700 "
                        placeholder="Write a title" required>
                </div>

                <div class="md:col-span-2">
                    <label for="" class="text-black">Price</label>
                <input type="num"  name="price" placeholder="price" class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-700 text-black">
              </div>

             <div class="md:col-span-2">
                <label  class="float-left block  font-normal text-gray-400 text-lg">Add a Image :</label>
              ...
              <div class="md:col-span-2">
                <textarea name="description" rows="5" cols="" placeholder="Add a description *" class="text-black w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-700"  required></textarea>
              </div>
                ...
                <tbody class="w-auto divide-y divide-gray-100 border-t border-gray-100">
                  <tr class="hover:bg-gray-50 w-auto ">
                    <th class="flex gap-3 px-6 py-4 font-normal text-gray-900">
                        <div class="text-gray-400">{{ $data->title }}</div>
                    </th>

                    <td > <div class="text-gray-400">{{ $data->price }}</div></td>
                    <td class="px-6 py-4">{{ $data->description }}</td>


                    <td class="px-9 py-4 w-56">
                         <img class="" src="/foodimage/{{ $data->image }}" >
                        </td>
                    ...
                    <td class="px-6 py-4">
                        <div class="flex justify-end gap-4">
                    <a x-data="{ tooltip: 'Edite' }" href="{{ url('/updateview',$data->id) }}">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                          viewBox="0 0 24 24"
